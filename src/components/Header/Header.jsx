        ...
        <ThemeProvider value={theme}>
          <Drawer open={open} onClose={closeDrawer} className="p-4">
            ...
            <div className=" mt-auto mb-4">
              <a href="mailto:abhiram.boddula@example.com">
                <CustomButton
                  text="email me"
                  icon={envelopeicon}
                  className='w-6'
