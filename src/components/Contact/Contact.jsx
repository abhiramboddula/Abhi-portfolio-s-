  ...
  return (
    <>
      ...
      <section className='container px-4 mx-auto'>
        ...
        <p className='text-accent my-20'>If you prefer to send an email directly instead of using form, feel free to reach out to me at <span className='font-bold italic'>abhiramboddula04@gmail.com</span>. Whether you have a specific project in mind, a question, or just want to connect and say hello, please don't hesitate to reach out. Drop me a message below, and I'll get back to you as soon as possible. Click <a href="mailto:abhiramboddula04@gmail.com" className='text-white underline'>here</a> to send an email directly.</p>
