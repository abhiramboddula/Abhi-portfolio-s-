    ...
    <>
      ...
      <section className='container px-4 mx-auto'>
        ...
        <div className='py-20'>
          ...
          <p className='text-accent'>Hi, I'm Abhiram Boddula, a web developer from Haryana, India. I create engaging and interactive websites with a passion for coding. Currently pursuing a BCA online, I'm deeply focused on both front-end and back-end development to enhance my skills.</p><br />
