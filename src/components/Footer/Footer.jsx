...
function Footer() {
  return (
    <footer className="mt-auto mx-auto container p-4 pt-10 ">
      <div className="flex flex-col items-center lg:flex-row lg:items-end lg:justify-between gap-6 mb-10 lg:mb-14">
